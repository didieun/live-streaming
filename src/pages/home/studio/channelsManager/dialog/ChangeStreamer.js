...
import {
    ...
    TabBox, FormControlBox, SubText, NickNameListBoxWidth, SubTextColor, TitleText, TextStyle
        ...
        <ChangeStreamerContainer>
            ...
            {tabValue === 'inviteNow' &&
                <>
                    ...
                    <NickNameListBoxWidth>
                        <TextStyle>
                            We are looking for streamers to broadcast live on various topics on the Channel Id channel. Please accept the invitation.
                        </TextStyle>
                    </NickNameListBoxWidth>
