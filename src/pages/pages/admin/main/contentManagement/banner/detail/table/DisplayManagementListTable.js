...
import {
    ...
    ExpirationDateBox,
    BorderRight4,
    FormControlLabelBox, SwitchStyle
...
const rows = [
    ...
    createData(7, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(8, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(9, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(10, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(11, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(12, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(13, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(14, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
    createData(15, '', 'abc-12345678', '1.5', '123', '', 'S.title','2023. 06. 09 11:20', 120, '김중계', 6),
];

function DisplayManagementListTable() {
    ...
    return (
        <div>
            <TableContainerBoxScroll component={Paper} sx={{ maxHeight: 'calc(100vh - 751px)' }}>
...
export default DisplayManagementListTable;