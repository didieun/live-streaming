...
function BackgroundImagePropertiesDialog(props) {
    ...
    return (
        <Container>
            ...
            <Flex>
                ...
                <div>
                   <AlignCenter>
                    ...
                    <SubText>
                        * Make sure your image size is a minimum of 640 pixels wide.<br/>&nbsp;&nbsp;&nbsp;(an aspect ratio of 16:9).<br/>
                        * Images can be uploaded up to 100MB.<br/>
                        * Make sure Formats is JPG, GIF, BMP, or PNG.
                    </SubText>
                </div>
            </Flex>
            ...
            <Flex>
                <TitleText>Screen Fit</TitleText>
                <FormControlBox>
                    <RadioGroup
                        row
                        defaultValue="yes"
...
export default BackgroundImagePropertiesDialog;
