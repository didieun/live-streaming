...
import {
    ...
    Section,
    ButtonIcon,
    TooltipStyle, AsideFullScreen, ContentsFullScreen, OfflineSection
        ...
        <Container>
            ...
            {fullScreen ?
                ...
                <Contents>
                        ...
                        {offline ?
                            <OfflineSection>
                                <WatchingVideo
                                    ...
                                    handleClickExitFullScreen={handleClickExitFullScreen}
                                    fullScreen={fullScreen}
                                    open={open}
                                    handleClickChat={handleClickChat}
                                    offline={offline}
                                />
                                <WatchingInfo handleClickBuyPointsDialog={handleClickBuyPointsDialog} offline={offline}/>
                            </OfflineSection>
                            :
                            <Section open={open}>
                                <WatchingVideo
                    ...
                    <WatchingIntroduction open={open} offline={offline}/>
                    <WatchingNotifications
                        notificationsOpen={notificationsOpen}
                        handleClickInviteToStreamDialogOpen={handleClickInviteToStreamDialogOpen}
                        handleCloseNotifications={handleCloseNotifications}
