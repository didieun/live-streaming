...
import {
    ...
    IconColorSize,
    LiveBox,
    ViewersText, VideoBoxTop, OfflineContainer, Offline, OfflineText, OfflineButton
...
import {ReactComponent as OffLineIcon} from "../../../common/images/OffLineIcon.svg";
import {ReactComponent as OfflineBellOnIcon} from "../../../common/images/OfflineBellOnIcon.svg";
import {ReactComponent as OfflineBellOffIcon} from "../../../common/images/OfflineBellOffIcon.svg";
import {TooltipStyle} from "../../streaming/styles/StreamingStyle";
import {Typography} from "@mui/material";

function WatchingVideo(props) {
    const {handleClickFullScreen, fullScreen, open, handleClickChat, handleClickExitFullScreen, offline} = props;
    const [isHovering, setIsHovering] = React.useState(false);
    const [volume, setVolume] = React.useState(true);
    const [play, setPlay] = React.useState(true);
    const [volumeValue, setVolumeValue] = React.useState(50);
    const [offlineButton, setOfflineButton] = React.useState(false);
    ...
    const handleClickNotifications = () => {
        setOfflineButton(!offlineButton);
    };
        ...
        <div>
            {offline ?
                <OfflineContainer>
                    ...
                    <OfflineText>
                        채널명 channel is offline.
                    </OfflineText>


                    <OfflineButton onClick={handleClickNotifications} disableRipple>
                        {offlineButton ?
                            <OfflineBellOffIcon/>
                            :
                            <OfflineBellOnIcon/>
                        ...
                        {offlineButton ?
                            <Typography>Turn off Notifications.</Typography>
                            :
