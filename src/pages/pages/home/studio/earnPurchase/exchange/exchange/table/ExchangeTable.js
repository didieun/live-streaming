...
import {
    NoTableCell,
    ChannelIdText,
} from "../../../../channelsManager/style/ManagerStyle";
...
const rows = [
    ...
    createData(2, <EarnedIcon/>, 'earned', false, 'Points Received', 'plus','10', '95.6', '2023. 06. 08 14:20', 'Channel Owner', 'Chris', 'abc-12345678', 'abc-12345678'),
            ...
            <TableContainerBox component={Paper}>
                <Table sx={{ minWidth: 650 }}>
                    ...
                    {rows.length > 0 ?
                        ...
                        <CommonTableEmpty
                            image={<EmptyIconBox/>}
                            title={'Try doing something.'}
                            message={
                                <span>
                                    To broadcast live, first <span style={{color: '#2e8c6a'}}>find the channel you want</span>. Or buy points and give gifts to your favorite channels.
                                </span>
                            }
                            action={true}
                            actionText1={'Buy Points'}
                        />
                    }
                </Table>
                {/* 검색 걸과 없을 시,*/}
