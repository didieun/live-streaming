...
function SideBar({open, menu, handleClickMenu, handleClickEarnMenu, earnMenu, handleClickEarnSubMenu, closeSideBarOpen, handleClickTag}) {
    ...
    return (
        ...
        >
            ...
            <MainSide open={open} menu={menu} handleClickMenu={handleClickMenu} handleClickTag={handleClickTag}/>
