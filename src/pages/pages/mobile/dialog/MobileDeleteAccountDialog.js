...
import {
    ...
    StyledTextarea2,
    ContainerIn,
    ActionBox, ButtonStyle, FormControlLabelCheckBox, WarningButton, RedText, UnderlineText, FlexEnd, StyledTextarea
...
function MobileDeleteAccountDialog(props) {
        ...
        <Container>
            <ContainerIn>
                ...
                <FormControlLabelCheckBox
                    control={<Checkbox checkedIcon={<Checked style={{width: 20, height: 20}}/>} icon={<UnChecked style={{width: 20, height: 20}}/>}/>}
...
export default MobileDeleteAccountDialog;