...
import {
    ButtonIcon, DrawerBox, MessageBox, TopBox
} from "./styles/MobileViewerProfileMenuStyle";
...
function MobileViewerProfileMenu(props) {
...
export default MobileViewerProfileMenu;