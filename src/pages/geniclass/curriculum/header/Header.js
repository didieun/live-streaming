...
import { headerHeight } from '../Curriculum';
...
function Header(props) {
    ...
    return (
        <Container>
            ...
            <Flex sx={{ gap: '24px' }}>
                <IconButtonStyle disableRipple sx={{ width: 30, height: 30, marginLeft: '0 !important' }}>
                    <PencilCircleIcon />
                </IconButtonStyle>
                <IconButtonStyle disableRipple sx={{ width: 30, height: 30, marginLeft: '0 !important' }}>
                    {/*<BellIcon/>*/}
                ...
                <IconButtonStyle sx={{ width: 30, height: 30, marginLeft: '0 !important' }} aria-haspopup="true" disableRipple>
                    <UserIcon />
                </IconButtonStyle>
            </Flex>
        </Container>
