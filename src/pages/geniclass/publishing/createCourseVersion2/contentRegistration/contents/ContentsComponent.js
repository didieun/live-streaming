...
const Container = styled(Box)(({ theme, contentsWidth }) => ({
    width: '100%',
    display: 'flex',
    flexDirection: contentsWidth < 800 ? 'column' : 'row',
...
function ContentsComponent(props) {
    ...
    return (
        <Container contentsWidth={contentsWidth}>
            <ContentsBoxStyle sx={{ marginBottom: contentsWidth < 800 ? '25px' : 0 }} contentsWidth={contentsWidth}>
                <ContentsTop>
                ...
                >
                    ...
                    />
                    <ContentsListBox contentsWidth={contentsWidth}>
            ...
            <ContentsBoxStyle contentsWidth={contentsWidth}>
                <ContentsTop>
                ...
                >
                    ...
                    <ContentsListBox contentsWidth={contentsWidth}>
                        {addContentsList.map((list, i) => (
                            <AddContentsBox index={i} list={list} contentsWidth={contentsWidth} />
                        ))}
                    </ContentsListBox>
                </ContentsBoxIn>
            </ContentsBoxStyle>
