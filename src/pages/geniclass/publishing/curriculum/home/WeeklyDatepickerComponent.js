...
function WeeklyDatepickerComponent(props) {
    ...
    return (
        <Root isLg={isLg}>
            <FlexSpace>
                <ControlBox>
                    <IconButtonStyle><CalendarLeftArrowIcon/></IconButtonStyle>
                    <Box>3월</Box>
                    <IconButtonStyle><CalendarRightArrowIcon/></IconButtonStyle>
                </ControlBox>
                <CalendarButton onClick={handleClickStart}><CalendarBlankIcon /></CalendarButton>
            </FlexSpace>
            <DatepickerStyle>
                <Datepicker
                    locale={ko}
